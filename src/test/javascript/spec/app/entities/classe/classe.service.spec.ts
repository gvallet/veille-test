...
describe('Service Tests', () => {
  describe('Classe Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Classe(0, 'AAAAAAA', 0, 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should update a Classe', async () => {
        const returnedFromService = Object.assign(
          {
            name: 'BBBBBB',
            nbStudents: 1,
      ...
      it('should return a list of Classe', async () => {
        const returnedFromService = Object.assign(
          {
            name: 'BBBBBB',
            nbStudents: 1,
      ...
      it('should delete a Classe', async () => {
